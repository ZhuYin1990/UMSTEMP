...
public class MenuService{
	...
	public List<Menu> getUserMenu(String userId) throws Exception {
		List<Menu> userMenuList = this.getUserParentMenu(userId);
		for(Menu menu : userMenuList) {
			PageData pd = new PageData();
			pd.put("user_id", userId);
			pd.put("parent_id", menu.getId());
			List<Menu> subMenuList = this.getUserSubMenu(pd);
			menu.setSubMenu(subMenuList);
		}
		return userMenuList;
	}
	
	public List<Menu> getUserParentMenu(String userId) throws Exception {
		return (List<Menu>) dao.findForList("MenuMapper.getUserParentMenu", userId);
		
	}
	
	public List<Menu> getUserSubMenu(PageData pd) throws Exception {
		return (List<Menu>) dao.findForList("MenuMapper.getUserSubMenu", pd);
	...
	public List<Menu> getAllParentMenu() throws Exception {
		return (List<Menu>) dao.findForList("MenuMapper.getAllParentMenu", null);
		
	}
	
	
	public List<Menu> getAllSubMenu(PageData pd) throws Exception {
		return (List<Menu>) dao.findForList("MenuMapper.getAllSubMenu", pd);
